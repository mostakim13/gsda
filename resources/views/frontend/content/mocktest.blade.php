...
<div class="item">
  <div class="cours-bx">
    ...
    <a href="{{ url('mock_details/'.$row->id.'/'.$row->elearning_slug) }}"><img src="{{asset("storage/courses/$row->course_image")}}" alt="" height="420"
      width="700"></a>
        <?php
      ...
      @else
        <a href="/mock_details/view/{{$row->id}}/{{ $row->elearning_slug }}" class="btn"><i class="fa fa-eye"></i></a>
      @endif

    </div>
    <div class="info-bx text-center">
      <h5><a href="{{ url('mock_details/'.$row->id.'/'.$row->elearning_slug) }}">{{Str::limit($row->course_title,18)}}</a></h5>
