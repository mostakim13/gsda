        ...
        <div class="">
            ...
            <div class="section-area section-sp1 ">
                <div class="container">
                    ...
                    {{-- {{ dd($classroomCertificateNo) }} --}}
                    <form action="{{ route('certificate-searching') }}" method="post">
                        @csrf
                        <div class="row d-flex justify-content-center">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Verify Your Certificate</label>
                                <input type="number" class="form-control" id="inputEmail4" name="certificateNo"
