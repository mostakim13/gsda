        ...
        <nav class="ttr-sidebar-navi">
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('trainer') }}" class="ttr-material-button"><span
                                    class="ttr-label">E-Learning</span></a>
                        </li>
                        <li>
                            <a href="{{ route('trainer-classroom') }}" class="ttr-material-button"><span
                                    class="ttr-label">Classroom</span></a>
                        </li>
                    </ul>
                </li>
                <li>
