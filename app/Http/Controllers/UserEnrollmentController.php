...
class UserEnrollmentController extends Controller
{
...

    {
        ...
        if (count($user_enrollment) > 0) {
            ...
            $vimeo_ids = Course::leftJoin('lessons', 'courses.id', '=', 'lessons.course_id')
                ->where('courses.id', $id)
                ->get();
    ...
    public function getVimeoId(Request $request)
    {
        ...
        return $course = Course::leftJoin('lessons', 'courses.id', '=', 'lessons.course_id')
    ...
    public function StoreEvolution(Request $request)
    {
        ...
        $evolution->certificate_no = '202201' . $course_id . $user_id;
