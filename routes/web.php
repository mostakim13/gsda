...
use App\Http\Controllers\Quiz\CategoryController;
...
Route::get('/admin/home/main_category/add', [MainCategoryController::class, 'add'])->name('addmain-category')->middleware('is_admin');
Route::post('/admin/home/main_category/store', [MainCategoryController::class, 'storeMCategory'])->name('store-mcategory')->middleware('is_admin');
...
Route::get('/admin/home/course_category/manage', [CourseCategoryController::class, 'Manage'])->name('managecourse-category')->middleware('is_admin');
Route::post('/admin/home/course_category/store', [CourseCategoryController::class, 'storeCourseCategory'])->name('store-maincategory')->middleware('is_admin');
...
Route::get('/admin/home/courses/manage', [CourseController::class, 'Manage'])->name('manage-course')->middleware('is_admin');
Route::post('/admin/home/courses/store', [CourseController::class, 'StoreCourse'])->name('store-course')->middleware('is_admin');
...
Route::get('/admin/home/classroom/courses/manage', [ClassroomCourseController::class, 'Manage'])->name('manage-classroom-course')->middleware('is_admin');
Route::post('/admin/home/classroom/courses/store', [ClassroomCourseController::class, 'StoreCourse'])->name('store-classroom-course')->middleware('is_admin');
...
Route::get('/admin/home/accreditation/manage', [AccreditationController::class, 'Manage'])->name('accreditation')->middleware('is_admin');
...
Route::get('/admin/home/system_settings/manage', [SystemController::class, 'Manage'])->name('manage-system-settings')->middleware('is_admin');
Route::post('/admin/home/system_settings/store', [SystemController::class, 'StoreSettings'])->name('store-system-settings')->middleware('is_admin');

//admin blog add
Route::get('/admin/home/blogs/manage', [AdminBlogController::class, 'index'])->name('manage-blogs')->middleware('is_admin');
Route::post('/admin/home/addBlog', [AdminBlogController::class, 'addBlog'])->name('add-blogs')->middleware('is_admin');
Route::post('/admin/home/UpdateBlog', [AdminBlogController::class, 'updateBlog'])->name('update-blogs')->middleware('is_admin');

Route::get('/admin/home/deleteBlog/{id}', [AdminBlogController::class, 'deleteBlog'])->name('delete-blogs')->middleware('is_admin');
Route::get('/admin/home/blogs/details/{id}', [AdminBlogController::class, 'BlogDetails'])->middleware('is_admin');

Route::get('/admin/home/blogs/details/view/{id}', [AdminBlogController::class, 'BlogView'])->middleware('is_admin');

Route::post('/admin/home/blogs/details/store', [AdminBlogController::class, 'Store'])->name('store-blog-details')->middleware('is_admin');
Route::post('/admin/home/UpdateBlogDetails', [AdminBlogController::class, 'updateBlogDetails'])->name('update-blog-details')->middleware('is_admin');

//admin add events
Route::get('/admin/home/events/manage', [AdminEventController::class, 'index'])->name('manage-events')->middleware('is_admin');
Route::post('/admin/home/events/store', [AdminEventController::class, 'Store'])->name('store-events')->middleware('is_admin');
Route::post('/admin/home/events/update', [AdminEventController::class, 'Update'])->name('update-events')->middleware('is_admin');
Route::get('/admin/home/events/delete/{id}', [AdminEventController::class, 'Delete'])->middleware('is_admin');
Route::get('/admin/home/events/event-details/{id}', [AdminEventController::class, 'EventDetails'])->middleware('is_admin');
Route::post('/admin/home/events/event-details/store', [AdminEventController::class, 'StoreDetails'])->name('store-event-details')->middleware('is_admin');
Route::post('/admin/home/events/event-details/update', [AdminEventController::class, 'UpdateDetails'])->name('update-event-details')->middleware('is_admin');
Route::get('/admin/home/events/event-details/view/{id}', [AdminEventController::class, 'EventDetailView'])->middleware('is_admin');



//admin add course without exam

Route::get('/admin/home/training_without_exam_courses/manage', [TrainingCourseController::class, 'Manage'])->name('manage-training-course')->middleware('is_admin');
Route::post('/admin/home/training_without_exam_courses/store', [TrainingCourseController::class, 'Store'])->name('store-training-course')->middleware('is_admin');
...
Route::get('/admin/home/evolution/manage', [UserController::class, 'ManageEvolution'])->name('manage-evolution')->middleware('is_admin');

//currency route
Route::get('/admin/home/manage', [CurrencyController::class, 'index'])->name('admin.currency')->middleware('is_admin');
Route::get('/admin/home/manage', [CurrencyController::class, 'index'])->name('admin.currency')->middleware('is_admin');
Route::post('/admin/home/store', [CurrencyController::class, 'store'])->name('admin.currency.store')->middleware('is_admin');
Route::post('/admin/home/update', [CurrencyController::class, 'store'])->name('admin.currency.update')->middleware('is_admin');
Route::get('/admin/home/delete/{id}', [CurrencyController::class, 'delete'])->middleware('is_admin');
...
Route::post('/admin/home/addTrainer', [TrainerController::class, 'addTrainer'])->name('add-trainer')->middleware('is_admin');
Route::post('/admin/home/updateTrainer', [TrainerController::class, 'updateTrainer'])->name('update-trainer')->middleware('is_admin');
...
Route::post('/admin/home/classroom-addTrainer', [TrainerController::class, 'addTrainer1'])->name('add-trainer1')->middleware('is_admin');
Route::post('/admin/home/classroom-updateTrainer', [TrainerController::class, 'updateTrainer1'])->name('update-trainer1')->middleware('is_admin');
...
Route::resource('/admin/all_reports', AllReportController::class);
Route::delete('reset/response/{topicid}/{userid}', [AllReportController::class, 'delete']);
Route::resource('/admin/top_report', TopReportController::class);
Route::get('/mock_details/{class_course}/{slug}', [FrontendController::class, 'mock_details_frontend'])->name('classroom-course-detail');
